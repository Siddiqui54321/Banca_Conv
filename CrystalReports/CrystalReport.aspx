...
<%@ Register TagPrefix="cr1" Namespace="CrystalDecisions.Web" Assembly="CrystalDecisions.Web, Version=13.0.30.3805, Culture=neutral, PublicKeyToken=692fbea5521e1304" %>
--%>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<cr1:crystalreportviewer id="Crv" style="Z-INDEX: 101; POSITION: absolute; TOP: 56px; LEFT: 16px" runat="server"
				Height="50px" Width="350px"></cr1:crystalreportviewer>
            
            <%--    <asp:button id="btnExp" style="Z-INDEX: 102; POSITION: absolute; TOP: 8px; LEFT: 88px" runat="server"
            ...
            <DIV id="divExp" style="Z-INDEX: 103; BORDER-BOTTOM: gray 1px solid; POSITION: absolute; BORDER-LEFT: gray 1px solid; WIDTH: 184px; HEIGHT: 40px; BORDER-TOP: gray 1px solid; TOP: 8px; BORDER-RIGHT: gray 1px solid; LEFT: 160px"
				runat="server" ms_positioning="GridLayout"><asp:dropdownlist id="ddLExp" style="Z-INDEX: 101; POSITION: absolute; TOP: 8px; LEFT: 8px" runat="server"
					Height="24px" Width="128px"></asp:dropdownlist>
                    
                    <%--<asp:button id="btnOK" style="Z-INDEX: 104; POSITION: absolute; TOP: 8px; LEFT: 144px" runat="server"
					Width="32px" Text="ok"></asp:button>
                    --%>
                    </DIV>
