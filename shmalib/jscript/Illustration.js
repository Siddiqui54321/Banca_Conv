...
var reportType_HISTORY = "HISTORY";					//chg-hist
var reportType_STATUS = "STATUS";					//chg-hist
var reportType_PROPOSALINQ  = "PROPOSALINQ";
var reportType_SECURITYLOG  = "SECURITYLOG";
var reportType_PROPSUMMARY  = "PROP_SUMMARY";
var reportType_DDA = "DDAFORM"; // for JSB 17 page report PersonalDetailand Illustration
var reportType_DDAJSB = "DDAJSB"; //  for JSB 1 page new report only for JSB
var reportType_JSPRO = "PROFILEJS"; // for JSB Profile
...
function openReportInPopup(reportType)
{
	...
	else if (reportType == "HISTORY") {														//CHG-HIS
		var proposal = document.getElementById('txtSearch').value;
		str_target = "ExecuteReport.aspx?_Proposal=" + proposal + "&_ReportType=" + reportType;
	}
	else if (reportType == "STATUS") {														//CHG-HIS
		var proposal = document.getElementById('txtSearch').value;
		str_target = "ExecuteReport.aspx?_Proposal=" + proposal + "&_ReportType=" + reportType;
	}
