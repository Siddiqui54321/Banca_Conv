	...
	public class NumGenInfo {
		...
		public NumGenInfo(string entityID,  NameValueCollection columnNameValue) 
		{
			...
			foreach(DataRow drow in table.Rows) 
			{
                ...
                {
                    //KeyNumGenDB.UpdateLockNumGen(entityID, strFieldComb, strValueComb); //Added by SDK as Instruted by M.Shamsher
				...
				if (table1.Rows.Count>0)
				{
					...
					if((!columnNameValue.ContainsKey(keyColumnName)) || keyColumnName == "" || keyColumnName == null)
						throw new Exception ("KeyColumn Not Properly Defined in Number Generation Setup");
