<%@ Page language="c#" Codebehind="PendingListForCallCenterApproval.aspx.cs"  AutoEventWireup="True" Inherits="SHAB.Presentation.PendingListForCallCenterApproval" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<table cellpadding="0" cellspacing="0" width="100%" border="0">
				<tr class="form_heading">
					<td height="20" colSpan="4" valign="middle" align="center">Call Center Proposals Approved for Collection 
					</td>
				</tr>
				<tr>
					<td></td>
