...
<%@ Page language="c#" Codebehind="shgn_dh_se_displayselection_ILUS_ET_DS_UC_USERCOUNTRY.aspx.cs" AutoEventWireup="True" Inherits="SHAB.Presentation.shgn_dh_se_displayselection_ILUS_ET_DS_UC_USERCOUNTRY" %>
		...
		<form id="myForm" name="sample" method="post" runat="server">
			...
			<div id="SelectionDiv" class="SelectionDiv"><fieldset><legend>Detail</legend>
					<TABLE id="entryTable" cellSpacing="5" cellPadding="1" width="60%" border="0">
						<TR id='row1'>
							<TD class="<%=getHighLighted()%>">User ID</TD>
							<TD nowrap>
								<shma:ComboBox ListWidth="400" Validation="Y" ValueField="USE_USERID" TextFields="USE_USERID,USE_NAME"
									...
									CssClass="RequiredComboText" HighLighted="True"></shma:ComboBox>
