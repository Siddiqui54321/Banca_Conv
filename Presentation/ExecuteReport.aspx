...
<asp:Panel id=pnlSecurityLog Runat="server">
  ...
  <TR>
    ...
    <TD>
<SHMA:dropdownlist class=DropDownField id=ddlREPORT runat="server" CssClass="REQUIREDFIELD" Width="6pc"><asp:ListItem Value="LOGINLOG">Login Log</asp:ListItem><asp:ListItem Value="ACTIVITYLOG">Activity Log</asp:ListItem></SHMA:dropdownlist></TD>
    <TD width="20%"></TD>
    <TD></TD></TR>
...
<asp:CompareValidator id=cfvDATETO runat="server" Display="Dynamic" ErrorMessage="Date Format is Incorrect " Type="Date" Operator="DataTypeCheck" ControlToValidate="txtDATETO"></asp:CompareValidator></TD></TR>
  <TR class=TRow_Normal id=row4>
				<TD align=center colSpan=4>
					<asp:Button id=btnGenerate runat="server" CssClass=""  Text="Continuee" onclick="btnGenerate_Click"></asp:Button>
					&nbsp;&nbsp;&nbsp;
				    <asp:Button ID="btnExcel" runat="server" CssClass="" onclick="btnExcel_Click" Text="Export To Excel" />
