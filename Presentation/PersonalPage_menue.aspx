...
<HTML>
	<HEAD>
        ...
        <script src="JSFiles/JScriptFG.js" type="text/JavaScript"></script>
		<script src="JSFiles/msrsclient.js" type="text/JavaScript"></script>
        ...
        <script src="../shmalib/jscript/WebUIValidation.js" type="text/JavaScript"></script>
		...
		<%--<SCRIPT language="JavaScript" src="../shmalib/jscript/WebUIValidation.js"></SCRIPT>--%>
         ...
         <script type="text/javascript">
             ...
             function DDAVisibility(bcode) {

                 if (bcode === 'F') {
                     OptDDAJSB.style.display = "block";
                 }
                 else {
                     OptDDAJSB.style.display = "none";
		...
		<script language="JavaScript">
			...
			//	alert(entityId);
				...
				{
					document.getElementById('mainContentFrame').style.height = '550.0px';
					setCurrentImage('imgPersonal');
					obj1 = document.getElementById("img2");
					obj1.src="images/Navigation/Plan.jpg";	
				}
				...
				if (currentScreen=='shgn_gp_gp_ILUS_ET_GP_BENEFECIARY')
				{
					...
					document.getElementById('mainContentFrame').style.height = '620.0px';
					obj1 = document.getElementById("img2");
				...
				{					
					document.getElementById('mainContentFrame').style.height = '460.0px';
				...
				{					
					document.getElementById('mainContentFrame').style.height = '450.0px';
					document.getElementById('mainContentFrame').style.width = '800.0px';
				}
				...
				{
					document.getElementById('mainContentFrame').style.height = '480.0px';
				}

                if (currentScreen == 'PolicyAlterReqPageGroup') {
                    document.getElementById('mainContentFrame').style.height = '1150.0px';
                }
																		...
																		<table width="475" border="0" cellspacing="3" cellpadding="3">
																			...
																			<tr>
																				<td colspan="3" align="center" height="5">
																					<asp:label id="lblTestVersion" Runat="server" ForeColor="#009AE4"  Font-Size="XX-Large"
...
<%--																			<br>
																			Month :
																			<asp:Literal id="_loggedMonth" runat="server"></asp:Literal>--%>
<%--//chg_closing_end--%>
																		</p>
																	</td>
																</tr>
																...
																<tr id="rptIllustration">
																	<td><a runat="server" id="OptionIllustration" onClick="executeReport('ILLUSTRATION');" class="image" href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Illustration 
																			Printing</a></td>
																</tr>
																...
																<tr id="rptAdvice" style="DISPLAY:none">
																	<td id="TDhlkAdvice"><a runat="server" id="OptionAdvice" onClick="executeReport('ADVICE');" class="image" href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Advice 
																			Printing</a>
																	</td>
																</tr>
																<tr id="rptProfile">
																	<td>
                                                                        <%--<a runat="server" id="OptionProposProfile" onClick="executeReport('PROFILEJS');" class="image" href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Personal 
																			Profile</a>--%>
                                            <a href="javascript:void(0);" class="image"
                                                 onclick='<%= (Session["BankCode"] != null && Session["BankCode"].ToString().ToUpper() == "F") 
                                                  ? "executeReport(\"PROFILEJS\");" 
                                                     : "executeReport(\"Profile\");" %>'>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Personal Profile
                                                        </a>
																...
																<tr id="rptPolicy">
																	<td><A runat="server" id="OptionPolicyPrint" onClick="executeReport('POLICY');" class="image" href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Policy 
																			Printing</A>
																	</td>
																</tr>
																<%--//chg-his--%>
																<%--<tr id="rptPayHis">
																	<td><A onClick="executeReport('HISTORY');" class="image" href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Payment 
																			History</A>
																	</td>
																</tr>
																<tr id="rptPolSta">
																	<td><A onClick="executeReport('STATUS');" class="image" href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Policy 
																			Status</A>
																	</td>
																</tr>--%>
																<tr id="rptPersonalInfo">
																	<td><A runat="server" id="OptionInquiry" onClick="executeReport('PROPOSALINQ');" class="image" href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Proposal 
																			Inquiry</A>
																	</td>
																</tr>

                                                                <tr id="rptDDAForm">
																	<td><A runat="server" id="OptDDAJSB" visible="true" onClick="executeReport('DDAJSB');" class="image" href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DDA 
																			Report</A>
																	</td>
																</tr>															
                                                                ...
                                                                <tr>
																	<td><a runat="server" id="OptionFormPrint" href="#" onClick="showPDF();" class="image">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Form 
																			Printing</a></td>
																...
																<tr>
																	<%--This Option is not required for PRD--%>
																	<td>
																		<a href="#" runat="server" id="OptionDispatch" visible="false" onClick="showDispatchData();" class="image">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Upload 
																			Dispatch Data</a>
																 ...
																 <tr>
																	<%--After Sale Portal option--%>
																	<td>
																		<a href="#" runat="server" id="OptionPolAlterRequest" visible="true" onClick="showPolicyAlterRequest();" class="image">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Post Policy Services 
																			</a>
																...
																<tr>
																	<td><a runat="server" id="OptionUnapprovPro" href="#" onClick="showUnApprovedProposal();" class="image">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Unapproved 
																			Proposals</a></td>
																</tr>
																<tr>
																	<td><a runat="server" id="OptionUserGuide" href="#" onClick="window.open('HelpFiles/BancassurancUsersGuide.pdf');" class="image">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;User 
																			Guide</a></td>
																</tr>
																<!--
...
<%--																				<br>
																				Month :
																				<asp:Literal id="_loggedMonth2" runat="server"></asp:Literal>--%>
<%--//chg_closing_end--%>
																			</p>
																		</td>
																	</tr>
												...
												<table style="WIDTH: 613px; HEIGHT: 332px" cellSpacing="5" cellPadding="10" width="613"
													...
													<tr>
														<td vAlign="top" id="ifrTD">
															<!--file here...-->
															<DIV style="Z-INDEX: 1; POSITION: static; WIDTH: 922px; HEIGHT: 515px; OVERFLOW: auto"
																...
																<iframe  id="mainContentFrame" frameborder="1" name="mainContentFrame" marginWidth="0" marginHeight="0"
																	src="../Presentation/shgn_ss_se_stdscreen_ILUS_ET_NM_WELCOME.aspx" scrolling="no"
	...
	function showProposalStatus(){
		setPage('ManualPolicyIssuanceSearch_Group');
            ...
            function showPDF()
            {
                setPage('PDFOpeningGroup');
            }


			function showDispatchData()
			{
                setPage('DispatchDataGroup');
            }


            function showPolicyAlterRequest() {
                setPage('PolicyAlterReqPageGroup');
            }
