...
{
	/// <summary>
	/// Summary description for shgn_gp_gp_ILUS_ET_GP_PLANRIDER.
	/// </summary>
	public partial class shgn_gp_gp_ILUS_ET_GP_PLANRIDER  : SHMA.CodeVision.Presentation.GroupBase
	{
			...
			if (Context.Session != null)
			{
				if (Session.IsNewSession)
				{
					if(Session["s_USE_USERID"]== null)
					{
						...
						Response.Write("parent.parent.document.location='../Presentation/LoginPage.aspx'");
