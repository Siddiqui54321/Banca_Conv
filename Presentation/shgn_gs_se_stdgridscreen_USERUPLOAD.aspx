...
<%@ Page language="c#" Codebehind="shgn_gs_se_stdgridscreen_USERUPLOAD.aspx.cs" AutoEventWireup="True" Inherits="SHAB.Presentation.shgn_gs_se_stdgridscreen_USERUPLOAD" %>
		...
		<form id="myForm" name="myForm" method="post" runat="server">
			...
			<table style="LEFT: 10px; POSITION: absolute; TOP: 50px" border="0" cellPadding="0" width="100%">
				<tr style="BACKGROUND-COLOR:#f4f8fb">
					<td width="33%" > </td>
					<td align="left">
						<A class="button2" onclick="UploadUsers();" href="#">Upload</A> 
					<td align="right"></td>
				</tr>
			</table>
