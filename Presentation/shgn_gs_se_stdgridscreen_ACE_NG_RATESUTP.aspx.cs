...
namespace SHAB.Presentation
{
	...
	public partial class shgn_gs_se_stdgridscreen_ACE_NG_RATESUTP : SHMA.Enterprise.Presentation.TwoStepController{
...
#region Events
	protected void _CustomEvent_ServerClick(object sender, System.EventArgs e) {
		...
		protected void Page_Unload(object sender, System.EventArgs e)
		{
			...
			/*SessionObject.Set("FILENAME",txtFILENAME.Text);
			  SessionObject.Set("SHEET",txtSHEET.Text);
		SessionObject.Set("LOCFROM",txtLOCFROM.Text);
		SessionObject.Set("LOCTO",txtLOCTO.Text);
		*/ 
		}
		/**
