<%@ Page language="c#" Codebehind="ListOfPendingAtCBCProposal_Group.aspx.cs" AutoEventWireup="True" Inherits="SHAB.Presentation.ListOfPendingAtCBCProposal_Group" %>
...
<html>
	<iframe ALIGN="top" id="ManualPolicy" FRAMEBORDER="0" MARGINWIDTH="0" width="100%" height="500px" name="ApprovedProposal" src="../Presentation/ListOfPendingAtCBCProposal.aspx?pid=0&amp;<%=ClientParams%>" style="mso-linked-frame:auto"  scrolling="yes">
