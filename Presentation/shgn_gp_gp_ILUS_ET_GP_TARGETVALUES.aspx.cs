...
{
	/// <summary>
	/// Summary description for shgn_gp_gp_ILUS_ET_GP_TARGETVALUES.
	/// </summary>
	public partial class shgn_gp_gp_ILUS_ET_GP_TARGETVALUES  : SHMA.CodeVision.Presentation.GroupBase
	{
