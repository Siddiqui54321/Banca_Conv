...
namespace SHAB.Presentation{
	public partial class shgn_dh_se_displayheader_ILUS_DH_BRANCHPRODUCT : SHMA.Enterprise.Presentation.PageController
	{				
		protected string CCH_CODE;
		protected string CN;
		protected string CCD_CODE;
		protected string CCD_DESCR;
		protected string CCS_CODE;
		protected string CCS_DESCR;
...
#region Major methods of the final step      		
		...
		private void GetSessionValues()
		{
			...
			CN=CCH_CHANNELDB.GetDESC_ILUS_DH_CHANNELSUBDTL_CN_RO();

			CCD_CODE=(string)SessionObject.Get("CCD_CODE");
			CCD_DESCR=CCD_CHANNELDETAILDB.GetDESC_ILUS_DH_CHANNELSUBDTL_CCD_DESCR_RO();

			CCS_CODE=(string)SessionObject.Get("CCS_CODE");
			CCS_DESCR=CCS_CHANLSUBDETLDB.GetDESC_ILUS_DH_CHANNELSUBDTL_CCD_DESCR_RO();
