...
namespace SHAB.Presentation
{
	...
	public partial class shgn_gs_se_stdgridscreen_RESETPASSWORD : SHMA.Enterprise.Presentation.TwoStepController{
	...
	sealed protected override void ApplyDomainLogic(DataHolder dataHolder) 
	{
		...
		switch ((EnumControlArgs)ControlArgs[0])
		{
			...
			case (EnumControlArgs.Process):						
				...
				//columnNameValue.Add("USE_PASSWORD",txtUSE_PASSWORD.Text.Trim()==""?null:(object)txtUSE_PASSWORD.Text);
				//columnNameValue.Add("USE_PASSWORD2",txtUSE_PASSWORD2.Text.Trim()==""?null:(object)txtUSE_PASSWORD2.Text);

				columnNameValue.Add("USE_PASSWORD",SessionObject.GetString("USE_USERID")+"**");
				columnNameValue.Add("USE_PASSWORD2",SessionObject.GetString("USE_USERID")+"**");				
...
#region Events
	protected void _CustomEvent_ServerClick(object sender, System.EventArgs e) {
		...
		protected void Page_Unload(object sender, System.EventArgs e)
		{
			...
			/*
			SessionObject.Set("DATEFROM",txtUSE_PASSWORD.Text);
			*/ 
		}
		/**
