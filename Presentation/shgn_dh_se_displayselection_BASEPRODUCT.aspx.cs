...
namespace SHAB.Presentation{
	public partial class shgn_dh_se_displayselection_BASEPRODUCT : SHMA.CodeVision.Presentation.DisplaySelectionBase {
		...
		protected sealed override void SetListsSource(){
			ddlPPR_PRODCD1.ListSource = new DataReaderDelegate(LPPR_PRODUCTDB.GetDDL_BASEPRODUCT_PPR_PRODCD1_RO);
