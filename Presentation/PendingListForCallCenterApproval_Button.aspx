<%@ Page language="c#" Codebehind="PendingListForCallCenterApproval_Button.aspx.cs" AutoEventWireup="True"  EnableEventValidation="false" Inherits="SHAB.Presentation.PendingListForCallCenterApproval_Button" %>
		...
		<table width="100%">
			<tr>
				<td class="button2TD" align="right">
					...
					<a href="#" class="button2" onclick="callRefresh();">&nbsp;&nbsp;Refresh&nbsp;&nbsp;</a>
