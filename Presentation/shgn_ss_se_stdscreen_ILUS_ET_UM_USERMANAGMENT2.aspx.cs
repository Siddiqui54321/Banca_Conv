...
namespace SHAB.Presentation
{
	...
	public partial class shgn_ss_se_stdscreen_ILUS_ET_UM_USERMANAGMENT2 : SHMA.Enterprise.Presentation.TwoStepController
	{
...
//		protected SHMA.Enterprise.Presentation.WebControls.DropDownList ddlUSE_TYPE;
//		protected System.Web.UI.WebControls.CompareValidator cfvUSE_TYPE;
//		protected SHMA.Enterprise.Presentation.WebControls.DropDownList ddlAAG_AGCODE;
//		protected SHMA.Enterprise.Presentation.WebControls.DropDownList ddlUSE_ACTIVE;
//		protected System.Web.UI.WebControls.RequiredFieldValidator rfvUSE_ACTIVE;
//		protected System.Web.UI.WebControls.CompareValidator cfvAAG_AGCODE;
//		protected System.Web.UI.WebControls.RequiredFieldValidator rfvUSE_TYPE;
		...
		{
//			IDataReader LAAG_AGENTReader0 = LAAG_AGENTDB.GetDDL_ILUS_ET_UM_USERMANAGMENT_AAG_AGCODE_RO();
//			ddlAAG_AGCODE.DataSource = LAAG_AGENTReader0 ;
//			ddlAAG_AGCODE.DataBind();
//			LAAG_AGENTReader0.Close();
//
//			IDataReader rdr = SmRlRoleDB.GetUserType();
...
//								
					...
					if (security.SaveAllowed)
					{
						...
						new USE_USERMASTER(dataHolder).Add(columnNameValue,getAllFields(),"ILUS_ET_UM_USERMANAGMENT2",null);
				...
				case (EnumControlArgs.Update):	
					...
					new ace.Change_Password().updateActiveuserpwd(txtUSE_USERID.Text,txtUSE_USERID.Text);

//					DB.BeginTransaction();
//					SaveTransaction = true;
//					dataHolder = new USE_USERMASTERDB(dataHolder).FindByPK(txtUSE_USERID.Text);				
//					columnNameValue.Add("USE_USERID",txtUSE_USERID.Text.Trim()==""?null:txtUSE_USERID.Text);
//					columnNameValue.Add("USE_NAME",txtUSE_NAME.Text.Trim()==""?null:txtUSE_USERID.Text);
////					columnNameValue.Add("USE_TYPE",ddlUSE_TYPE.SelectedValue.Trim()==""?null:ddlUSE_TYPE.SelectedValue);
////					columnNameValue.Add("AAG_AGCODE",ddlAAG_AGCODE.SelectedValue.Trim()==""?null:ddlAAG_AGCODE.SelectedValue);
////					columnNameValue.Add("USE_ACTIVE",ddlUSE_ACTIVE.SelectedValue.Trim()==""?null:ddlUSE_ACTIVE.SelectedValue);
//
...
//					}
				...
				case (EnumControlArgs.Delete):
					DB.BeginTransaction();
					new ace.Change_Password().chkuserpwd(txtUSE_USERID.Text,txtUSE_USERID.Text);
						
//					SaveTransaction = true;
//					dataHolder = new USE_USERMASTERDB(dataHolder).FindByPK(txtUSE_USERID.Text);				
//					columnNameValue.Add("USE_USERID",txtUSE_USERID.Text.Trim()==""?null:txtUSE_USERID.Text);
//					columnNameValue.Add("USE_NAME",txtUSE_NAME.Text.Trim()==""?null:txtUSE_NAME.Text);
//					columnNameValue.Add("USE_PASSWORD",updateuserpwd);
////				    columnNameValue.Add("AAG_AGCODE",ddlAAG_AGCODE.SelectedValue.Trim()==""?null:ddlAAG_AGCODE.SelectedValue);
////					columnNameValue.Add("USE_ACTIVE",ddlUSE_ACTIVE.SelectedValue.Trim()==""?null:ddlUSE_ACTIVE.SelectedValue);
//					security = new SHSM_SecurityPermission( Utilities.File2EntityID(this.ToString()), USE_USERMASTER.PrimaryKeys, columnNameValue, "USE_USERMASTER");
...
//				SessionObject.Set("USE_ACTIVE",ddlUSE_ACTIVE.SelectedValue);
		...
		{
			if(SessionObject.Get("s_USE_TYPE")==null || (SessionObject.GetString("s_USE_TYPE")!="A" && SessionObject.GetString("s_USE_TYPE")!= "R" && SessionObject.GetString("s_USE_TYPE") != "P"))
			{
