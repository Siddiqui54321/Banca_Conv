<%@ Page language="c#" Codebehind="ManualPolicyIssuanceOfPendingProposalsView.aspx.cs"   EnableEventValidation="false"
AutoEventWireup="True" Inherits="SHAB.Presentation.ManualPolicyIssuanceOfPendingProposalsView" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<table cellpadding="0" cellspacing="0" width="100%" border="0">
				<tr class="form_heading">
					<td height="20" colSpan="4" valign="middle" align="center">Pending Proposal List-3
					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
