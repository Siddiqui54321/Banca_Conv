<%@ Page language="c#" Codebehind="shgn_bt_se_button_ILUS_ET_GP_WITHDRAWALPOPS.aspx.cs" AutoEventWireup="True" Inherits="SHAB.Presentation.shgn_bt_se_button_ILUS_ET_GP_WITHDRAWALPOPS" %>
...
<table width=100% >
	<tr>
		<td align=right>
			...
			<a href="#" ><IMG onmouseover="this.src='../shmalib/images/buttons/exit_2.gif'" onmouseout="this.src='../shmalib/images/buttons/exit.gif'" border="0" name="btndelete" alt="" src="../shmalib/images/buttons/exit.gif" onclick="parent.window.opener.location.href = parent.window.opener.location.href; parent.window.close();"></a>
