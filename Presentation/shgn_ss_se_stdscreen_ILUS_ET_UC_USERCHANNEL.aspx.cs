...
namespace SHAB.Presentation
{
	...
	public partial class shgn_ss_se_stdscreen_ILUS_ET_UC_USERCHANNEL : SHMA.Enterprise.Presentation.TwoStepController{
...
#region Major methods of First Step
	...
	sealed protected override DataHolder GetInputData(DataHolder dataHolder)
	{
		GetSessionValues();
		//CheckKeyLevel();
		//recordCount = LUCH_USERCHANNELDB.RecordCount;
		return   dataHolder;         
...
columnNameValue.Add("CCH_CODEDEFAULT",ddlCCH_CODEDEFAULT.SelectedValue.Trim()==""?null:ddlCCH_CODEDEFAULT.SelectedValue);
...
#region Events
	private void _CustomEvent_ServerClick(object sender, System.EventArgs e) {
		...
		SessionObject.Set("CCH_CODEDEFAULT",ddlCCH_CODEDEFAULT.SelectedValue);
		*/ 
		}
		/**
