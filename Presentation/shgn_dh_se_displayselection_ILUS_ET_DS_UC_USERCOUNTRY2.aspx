...
<%@ Page language="c#" Codebehind="shgn_dh_se_displayselection_ILUS_ET_DS_UC_USERCOUNTRY2.aspx.cs" AutoEventWireup="True" Inherits="SHAB.Presentation.shgn_dh_se_displayselection_ILUS_ET_DS_UC_USERCOUNTRY2" %>
		...
		<form id="myForm" name="myForm" method="post" runat="server">
			<TABLE id="entryTable" cellSpacing="5" cellPadding="1">
				<tr class="form_heading">
					<td height="20" colSpan="2">&nbsp; User Authorized Country(s)
					</td>
				</tr>
				<TR id='row1'>
