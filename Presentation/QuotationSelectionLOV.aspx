<%@ Page language="c#" Codebehind="QuotationSelectionLOV.aspx.cs" AutoEventWireup="True" Inherits="Insurance.Presentation.QuotationSelectionLOV" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Quotation Selection</title>
	...
	<body MS_POSITIONING="GridLayout" oncontextmenu="return true;">
		<form id="Form1" method="post" runat="server">
			<table border="0">
				<tr>
					<td>
						<asp:TextBox style="Z-INDEX: 102" id="txtSearchEvent" runat="server" AutoPostBack="False" Width="0px"></asp:TextBox>
						<!--<asp:DropDownList style="Z-INDEX: 103;" id="ddlStatus" runat="server" tabIndex="1"
						Width="100px">
						<asp:ListItem Value="">All Quotations</asp:ListItem>
						...
						<asp:DropDownList style="Z-INDEX: 103" id="ddlsearch" runat="server" tabIndex="2" Width="110px">
						...
						<asp:Button style="Z-INDEX: 104" id="Button1" runat="server" tabIndex="4" Font-Bold="True" Font-Names="Arial"
							Text="Search" Height="20px" onclick="Button1_Click"></asp:Button>
					</td>
				</tr>
				<tr>
					<td>
						<asp:DataGrid id="dgProposalLOV" SelectedItemStyle-CssClass="GridSelRow" HeaderStyle-CssClass="GridHeader"
							tabIndex="4" runat="server" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" GridLines="Horizontal"
							...
							<Columns>
								<asp:ButtonColumn DataTextField="NP1_PROPOSAL" HeaderText="Quotation #" CommandName="Select">
									<HeaderStyle Font-Bold="True"></HeaderStyle>
								</asp:ButtonColumn>
								<asp:BoundColumn Visible="False" DataField="NP1_PROPOSAL" ReadOnly="True" HeaderText="Quotation #"></asp:BoundColumn>
								<asp:ButtonColumn DataTextField="" HeaderText="Status" CommandName="Select" Visible="False">
									<HeaderStyle Font-Bold="True"></HeaderStyle>
								</asp:ButtonColumn>
								<asp:ButtonColumn DataTextField="NPH_FULLNAME" HeaderText="Name" CommandName="Select">
									<HeaderStyle Font-Bold="True"></HeaderStyle>
								</asp:ButtonColumn>
								<asp:ButtonColumn DataTextField="NPH_IDNO" HeaderText="ID" CommandName="Select">
									<HeaderStyle Font-Bold="True"></HeaderStyle>
								</asp:ButtonColumn>
								<asp:ButtonColumn DataTextField="" HeaderText="Country" CommandName="Select" Visible="False">
									<HeaderStyle Font-Bold="True"></HeaderStyle>
								</asp:ButtonColumn>
							</Columns>
