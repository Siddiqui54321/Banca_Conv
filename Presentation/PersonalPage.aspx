...
<%--																<tr id="rptPayHis">      <td><A onClick="executeReport('HISTORY');"       class="image" href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Payment History</A>      </td></tr> 
																<tr id="rptPolSta">      <td><A onClick="executeReport('STATUS');"       class="image" href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Policy Status</A>      </td></tr> --%>
													...
													<tr>
														<td vAlign="top" id="ifrTD">
															...
															<div class="box1" id="layer1" style="Z-INDEX: 1; OVERFLOW: auto; WIDTH: 771px; POSITION: static">
																...
																<iframe id="mainContentFrame" style="frameborder="1" name="mainContentFrame"
