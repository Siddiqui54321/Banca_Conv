...
{
	/// <summary>
	/// Summary description for DownloadProposalFile.
	/// </summary>
	public partial class DownloadProposalFile : System.Web.UI.Page
	{
		...
		private void WriteFileOnClient()
		{
			try
			{
				...
				string downloadProposalFile =Session["downloadProposalFile"].ToString();
				string dfn = System.IO.Path.GetFileName(downloadProposalFile);
				string attachment = "attachment; filename="+dfn;
