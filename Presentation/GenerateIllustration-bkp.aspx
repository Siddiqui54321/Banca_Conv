<%@ Page language="c#" Codebehind="GenerateIllustration-bkp.aspx.cs" AutoEventWireup="True" Inherits="SHAB.Presentation.GenerateIllustrationbkp" %>
	...
	<body>
		...
		<form id="myForm" method="post" name="myForm" runat="server">
			...
			<div class="NormalEntryTableDivPlan" id="Div1" runat="server">
				<TABLE id="entryTablePlan" cellSpacing="0" cellPadding="2" border="0">
					...
					<TR class="TRow_Normal" id="rowNPR_PREMIUMTER_2" style="VISIBILITY: hidden">
						...
						<TD id="ctltxtNP1_RETIREMENTAGE" align="right" width="205"><shma:textbox id="txtNP1_RETIREMENTAGE" tabIndex="11" runat="server" CssClass="DisplayOnly" Width="184px"
								BaseType="Number" Precision="0" MaxLength="3" readonly="true"></shma:textbox><asp:comparevalidator id="cfvNP1_RETIREMENTAGE" runat="server" ControlToValidate="txtNP1_RETIREMENTAGE"
						...
						<td id="ctltxtNPR_SUMASSURED_2" align="right" width="205"><shma:textbox id="txtNPR_SUMASSURED_2" tabIndex="12" runat="server" CssClass="DisplayOnly" Width="184px"
								BaseType="Number" Precision="2" MaxLength="15" SubType="Currency" ReadOnly="true"></shma:textbox><asp:comparevalidator id="cfvNPR_SUMASSURED_2" runat="server" Display="Dynamic" ErrorMessage="Number Format is Incorrect "
				...
				<!--</FIELDSET>--></div>
			<INPUT id="Hidden1" type="hidden" name="_CustomArgName" runat="server"> <INPUT id="Hidden2" type="hidden" name="_CustomArgVal" runat="server">
			<INPUT id="Hidden3" type="hidden" name="_CustomEventVal" runat="server"> <INPUT id="Button1" style="WIDTH: 0px" type="button" value="Button" name="_CustomEvent"
				runat="server"> 
			<shma:textbox id="txtNP1_PROPOSAL" runat="server" BaseType="Character" width="0px"></shma:textbox>
			<shma:textbox id="txtNP2_SETNO" runat="server" Precision="0" BaseType="Number" width="0px"></shma:textbox>
