...
<%@ Page language="c#" Codebehind="shgn_ss_se_stdscreen_PRODUCTQUESTION.aspx.cs" AutoEventWireup="True" Inherits="SHAB.Presentation.shgn_ss_se_stdscreen_PRODUCTQUESTION" %>
...
<HTML>
	<HEAD>
		...
		{				
			if(myForm.ddlCQN_CODE.disabled==true)
				 myForm.ddlCQN_CODE.disabled=false;
				 myForm.ddlCQN_CODE.selectedIndex =0;
							 //myForm.txtCQN_DESC.value ="";
			
myForm.ddlCQN_CODE.focus();
			setDefaultValues();
		}
		/********** dependent combo's queries **********/
		
function copyToMultiText()
{
	alert(myForm.ddlCQN_CODE.selectedText);
}
	...
	<body>
		<UC:EntityHeading ParamSource="FixValue" ParamValue="Product wise Question setup" id="EntityHeading"
			runat="server"></UC:EntityHeading>
		<form id="myForm" name="myForm" method="post" runat="server">
			<div id="EntryTableDiv" runat="server">
				<fieldset>
					<TABLE id="entryTable" cellSpacing="5" cellPadding="1" border="0">
						<SHMA:TextBox id="txtPPR_PRODCD" style="display:none; width:0" runat="server" BaseType="Character"></SHMA:TextBox>
						...
						<TR id='rowCQN_CODE'>
							<TD>Question</TD>
							<TD><SHMA:dropdownlist id="ddlCQN_CODE" runat="server" BlankValue="True" DataTextField="desc_f" DataValueField="CQN_CODE"
									tabIndex="1" Width="40.0pc" CssClass="RequiredField"  ></SHMA:dropdownlist>
								<asp:CompareValidator id="cfvCQN_CODE" runat="server" ControlToValidate="ddlCQN_CODE" Operator="DataTypeCheck"
									Type="String" ErrorMessage="String Format is Incorrect " EnableClientScript="False" Display="Dynamic"></asp:CompareValidator>
								<asp:requiredfieldvalidator id="rfvCQN_CODE" runat="server" ErrorMessage="Required" ControlToValidate="ddlCQN_CODE"
									Display="Dynamic"></asp:requiredfieldvalidator>
							</TD>
						</TR>
						<!--<TR id='rowCQN_DESC'>
							<TD>Description</TD>
							<TD><SHMA:TextBox id="txtCQN_DESC" tabIndex="2" runat="server" Width='15.0pc' ReadOnly="true" MaxLength="500"
			...
			<DIV  id="ListerDiv" runat="server" style="left: 10px; top: 50px; width: 743px; HEIGHT: 300px; overflow: auto; position: absolute; font-family: arial;" >
				<FIELDSET class="ListerFieldSet" runat="server" id="ListerFieldSet">
					<TABLE class="" cellSpacing="2" cellPadding="0" border="0" width="90%">
						<TR class="ListerHeader">
							<TD onClick="filterLister('LPQN.CQN_CODE','Question')">Question</TD>
							<TD onClick="filterLister('CQN_DESC','Description')">Description</TD>
							<TD width="0"></TD>
						</TR>
