									...
									<td class="top_bg"><!-- #BeginLibraryItem "/Library/top.lbi" -->
										<table cellSpacing="0" cellPadding="0" width="100%" border="0">
                                            ...
                                            <tr>
												...
												<td vAlign="top" align="left" width="30%"><asp:label id="lblTestVersion" Font-Bold="True" Font-Size="XX-Large" Font-Names="Verdana" ForeColor="#009AE4"
...
<%--																				</tr>
																				<tr>
																					<td class="yesno" id="tdClosing" nowrap>Closing Month</td>
																					<td>
																						<asp:DropDownList runat="server" tabIndex="3" CssClass="textbox" Width="96px" AppendDataBoundItems="true" BorderStyle="None" BorderColor="Transparent" ID="ddlClosing">
																						</asp:DropDownList>--%>
<%--//chg_closing_End--%>
																					</td>
																				</tr>
