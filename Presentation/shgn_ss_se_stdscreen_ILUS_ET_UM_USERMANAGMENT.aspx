...
<HTML>
		...
		/********** dependent combo's queries **********/
            ...
            function validateEmail(txtEmail) {
                ...
                if (!emailPattern.test(email)) {
                    ...
                    emailField.value = "";  // Clear the invalid email
                    emailField.focus();  // Set focus back to the field
                    return false;
                }
                return true;
            }
	...
	<body>
        ...
        <asp:ScriptManager runat="server">
			...
			<div style="MARGIN-TOP: 20px; MARGIN-LEFT: 320px" id="EntryTableDiv" runat="server">
				...
				<TABLE id="entryTable" border="0" cellSpacing="5" cellPadding="1">
					...
					<TR id='rowUSE_ACTIVE' class="TRow_Alt">
						...
						<TD width="100">
							<shma:textbox id="txtEmail" tabIndex="6" runat="server" BaseType="Character" Width="16pc" 
								  EnableViewState="True" onblur="validateEmail(this.id)"></shma:textbox>
			...
			<INPUT style="WIDTH: 0px; display:none;" id="_CustomEvent" value="Button" type="button" name="_CustomEvent" causesvalidation="true"
				runat="server" onserverclick="_CustomEvent_ServerClick">
                <INPUT style="WIDTH: 0px; display:none;" id="_CustomEvent1" value="Button" type="button" name="_CustomEvent" causesvalidation="false"
				runat="server" onserverclick="_CustomEvent_ServerClick">
