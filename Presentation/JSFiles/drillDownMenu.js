...
function drilldownmenu(setting){
	this.sublevelarrow={src:'../Presentation/Images/right.gif', width:'8px', top:'3px', left:'6px'} //full URL to image used to indicate there's a sub level
	this.breadcrumbarrow='../Presentation/Images/right.gif' //full URL to image separating breadcrumb links (if it's defined)
	this.loadingimage='../Presentation/Images/loader.gif' //full URL to 'loading' image, if menu is loaded via Ajax
	...
	this.backarrow='../Presentation/Images/leftarrow.gif' //full URL to image added in front of back LI 
    /// <reference path="../Images/right.gif" />
