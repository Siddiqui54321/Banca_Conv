...
<HTML>
	...
	<body>
		...
		<form id="myForm" method="post" name="myForm" runat="server">
			...
			<INPUT style="WIDTH: 0px;visibility:hidden" id="_CustomEvent1" value="Button" type="button" name="_CustomEvent" causesvalidation="false"
				runat="server" onserverclick="_CustomEvent_ServerClick"> 
            <INPUT style="WIDTH: 0px;visibility:hidden" id="_CustomEvent" value="Button" type="button" name="_CustomEvent" causesvalidation="true"
